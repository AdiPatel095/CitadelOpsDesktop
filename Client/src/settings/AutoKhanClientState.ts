...
export interface AutoKhanClientStateV1 {
  ...
  maxRageChain: number;
  requireActiveRageBooster: boolean;
}
...
export function defaultAutoKhanClientState(): AutoKhanClientStateV1 {
  return {
    ...
    maxRageChain: 0,
    requireActiveRageBooster: false,
  };
}
...
export function parseAutoKhanClientState(value: unknown): AutoKhanClientStateV1 {
  ...
  return {
    ...
    maxRageChain: clampAutoKhanInteger(raw.maxRageChain, 0, Number.MAX_SAFE_INTEGER, 0),
    requireActiveRageBooster: raw.requireActiveRageBooster === true,
  };
}
