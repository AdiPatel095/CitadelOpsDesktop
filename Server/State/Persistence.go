...
func normalizeStateMaps(state *GameState) {
	...
	if state.Research.CompletedIDs == nil {
		state.Research.CompletedIDs = defaults.Research.CompletedIDs
	}
	...
	if state.AllianceHelpRequests.OwnRecruitmentRequests == nil {
		state.AllianceHelpRequests.OwnRecruitmentRequests = defaults.AllianceHelpRequests.OwnRecruitmentRequests
	}
