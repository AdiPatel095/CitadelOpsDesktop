...
func availablePresetCopies(preset AttackPresets.Preset, source State.CastleState, maximum int) int {
	if maximum <= 0 {
		return 0
	}
...
func nomadPresetWaiting(now time.Time, preset AttackPresets.Preset, source State.CastleState, metrics map[string]float64) Decision {
