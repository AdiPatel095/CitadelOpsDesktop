...
func TestCraftingPolicyRedistributesKhanLootAsOneCapacityFillingShipment(t *testing.T) {
	...
	if got, want := string(decision.Request.Arguments), `{"goods":[{"resourceId":6,"amount":80000},{"resourceId":7,"amount":70000},{"resourceId":8,"amount":60000}],"sourceCastleId":10,"targetCastleId":20,"workflowOwner":"autoSceatRes"}`; got != want {
