...
// caller intended to address. Some game commands, including recruitment AHR,
// omit that identity from their outbound payload and must carry it alongside
// the wire request instead.
