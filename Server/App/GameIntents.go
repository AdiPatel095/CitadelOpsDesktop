...
func (application *Application) registerGameIntents() error {
	...
	if err := application.Intents.RegisterAction("alliance.help.prepare_recruitment_bup", application.prepareStandaloneRecruitmentBUPAllianceHelp); err != nil {
		return err
	}
	if err := application.Intents.RegisterAction("alliance.help.reconcile_recruitment_bup", application.reconcileStandaloneRecruitmentBUPAllianceHelp); err != nil {
		return err
	}
	if err := application.Intents.RegisterStepResolver("alliance.help.build", application.resolveAllianceHelpRequestStep); err != nil {
		return err
	}
	if err := application.Intents.RegisterAction("production.enqueue.mark_help_due", application.markRecruitmentBUPAllianceHelpDue); err != nil {
		return err
	}
	...
	if err := application.Intents.RegisterAction("resources.kingdom.verify_pending", application.verifyKingdomResourceTransportPending); err != nil {
		return err
	}
	...
	if err := application.Intents.RegisterAction("khan.taunt.dispatched", application.rejectUnconfirmedKhanTauntDispatch); err != nil {
		return err
	}
	...
	if err := application.Intents.RegisterStepResolver("khan.taunt.build", resolveKhanTauntStep); err != nil {
		return err
	}
