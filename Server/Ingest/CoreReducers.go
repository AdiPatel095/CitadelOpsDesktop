...
func RegisterCoreReducers(registry *Registry) error {
	...
	reducers := []struct {
		...
		{"ovs", combineReducers(reduceResponseResources, reduceMarketBooster)},
		{"bms", combineReducers(reduceResponseResources, reduceMarketBooster)},
		{"btx", combineReducers(reduceResponseResources, reduceMarketBooster)},
		{"bis", combineReducers(reduceResponseResources, reduceMarketBooster)},
		{"bcs", combineReducers(reduceResponseResources, reduceMarketBooster)},
		{"brs", combineReducers(reduceResponseResources, reduceMarketBooster)},
		{"bfs", combineReducers(reduceResponseResources, reduceMarketFeast)},
		...
		{"sbp", combineReducers(reduceResponseResources, reduceShopFocusedUnits, reduceStormShopResponse)},
